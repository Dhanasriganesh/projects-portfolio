...
export default function FeaturedProjects({ projects }) {
  ...
  return (
    <section className="relative overflow-x-clip border-y border-brand py-16 sm:py-20 lg:py-28 mesh-rainbow">
      <div
      ...
      <Container className="relative">
        <div className="flex flex-col items-start justify-between gap-8 md:flex-row md:items-end">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 font-display text-3xl font-extrabold tracking-tight text-ink sm:text-4xl md:text-5xl lg:text-[3.25rem]">
          ...
          <ButtonLink to="/work" variant="ghost" className="w-full shrink-0 px-8 sm:w-auto">
            View full archive
          </ButtonLink>
        </div>
